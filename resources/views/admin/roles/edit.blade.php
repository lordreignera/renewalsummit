    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-5">
            <div class="bg-white rounded-2xl shadow-sm p-6 space-y-5">
                ...
                {{-- Slug (read-only) --}}
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Role Slug</label>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $role->description) }}</textarea>
                </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm p-6">
                <h2 class="font-bold text-gray-700 mb-4">Assigned Permissions</h2>
